...
export function TheArboristHomePage() {
  return (
    <div className="bg-[#050b12] text-stone-900">
      ...
      <section className="border-y border-teal-300/20 bg-[#07131b] px-4 py-4 text-white sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-3 text-sm font-black uppercase tracking-[0.14em] text-emerald-50 sm:grid-cols-3">
          <div className="rounded-full border border-teal-300/25 bg-white/[0.03] px-4 py-3">ISA Certified Arborist</div>
          <div className="rounded-full border border-teal-300/25 bg-white/[0.03] px-4 py-3">Serving the Gulf Coast</div>
          <div className="rounded-full border border-teal-300/25 bg-white/[0.03] px-4 py-3">Mobile and Baldwin Counties</div>
        </div>
      </section>

      <section id="services" className="relative isolate overflow-hidden bg-[#050b12] py-14 text-white sm:py-16">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {services.map(([title, text, Icon]) => (
              <article key={title} className="rounded-2xl border border-teal-300/20 bg-[#07131b]/80 p-5 shadow-[0_22px_54px_rgba(0,0,0,0.22)] backdrop-blur">
      ...
      <section id="about" className="scroll-mt-28 bg-[#050b12] py-14 text-white sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:px-8">
          <div className="rounded-2xl border border-teal-300/20 bg-white/[0.05] p-5 shadow-[0_20px_54px_rgba(0,0,0,0.24)]">
          ...
          <div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-teal-300/20 bg-white/[0.05] p-5">
                <Hammer className="size-8 text-[#f6c95a]" aria-hidden="true" />
      ...
      <section id="phone-consultation" className="relative isolate scroll-mt-28 overflow-hidden bg-[#0b1f17] py-14 text-white sm:py-16">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:px-8">
          <div className="rounded-2xl border border-teal-300/20 bg-white/[0.06] p-6 shadow-[0_20px_54px_rgba(0,0,0,0.24)] backdrop-blur">
            <CalendarDays className="size-10 text-[#f6c95a]" aria-hidden="true" />
            <div className="mt-5">
              <SectionHeading
                light
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#f6c95a] px-5 py-3 text-sm font-black uppercase tracking-[0.04em] text-[#06110d] shadow-[0_18px_38px_rgba(246,201,90,0.2)] transition hover:bg-[#ffdc70] focus-ring"
            >
      ...
      <section id="consultation-request" className="relative isolate scroll-mt-28 overflow-hidden bg-[#050b12] py-14 text-white sm:py-16">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:px-8">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <SchedulePhoneButton className="border-teal-300/25 bg-white/[0.06] text-white hover:bg-white/[0.1]" />
              <VerifyIsaButton className="border-teal-300/25 bg-white/[0.06] text-white hover:bg-white/[0.1]" />
            </div>
          </div>
