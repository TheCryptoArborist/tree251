...
const credibilityCards = [
  {
    ...
    text: "Peter does not need to sell removal, pruning, cabling, or storm cleanup work."
  },
  {
    title: "Local Mobile context",
    text: "Guidance for storm-exposed trees, mature live oaks, property lines, permits, and coastal weather pressure."
  },
  {
    title: "Decision-ready notes",
    text: "Clear priorities you can use before comparing quotes, approving work, or documenting a tree concern."
  }
] as const;

const education = [
  {
    title: "After a storm, look for more than broken limbs.",
    text: "Fresh cracks, lifted soil, a new lean, hanging limbs, exposed roots, or sudden canopy loss can change the priority of tree work."
  },
  {
    title: "Wrong pruning can increase tree risk.",
    text: "Lion-tailing, excessive canopy raising, and large unnecessary cuts can move weight to the ends of limbs and create avoidable problems."
  },
  {
    title: "A second opinion can protect tree value.",
    text: "Some work needs to happen quickly. Some work can wait. Some trees deserve preservation options before removal is approved."
  },
  {
    title: "Good photos make the first call more useful.",
    text: "Send the whole tree, trunk base, canopy, visible defect, nearby targets, and the decision you are trying to make."
  }
] as const;
    ...
    <div className="bg-[#06110d] text-stone-900">
      ...
      <section id="independent" className="scroll-mt-28 bg-white py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-8">
          <div>
            <SectionHeading
              title="Why hire an independent consulting arborist?"
              text="A tree service may be excellent at tree work, but it still has work to sell. An independent assessment gives you a clearer read before you commit money to removal, pruning, cabling, or storm cleanup."
            />
          ...
          <div className="rounded-md bg-[#06110d] p-6 text-white shadow-[0_20px_44px_rgba(6,17,13,0.22)]">
            <div className="flex items-center gap-3">
              <HeartHandshake className="size-10 text-lime-300" aria-hidden="true" />
              <h3 className="text-2xl font-black">Independent guidance before tree work.</h3>
            </div>
            <div className="mt-6">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-8">
          <div className="relative min-h-[22rem] overflow-hidden rounded-md border border-white/10">
            <Image
              ...
              alt="Tree canopy texture in dark green light"
              fill
            ...
            <div className="absolute bottom-0 p-6">
              <CloudLightning className="size-10 text-lime-300" aria-hidden="true" />
              <p className="mt-4 max-w-sm text-2xl font-black leading-tight">Storm decisions are easier when priorities are clear.</p>
            </div>
          </div>
          <div>
            <h2 className="text-3xl font-black leading-tight text-white sm:text-4xl">Storm damage and hurricane preparation.</h2>
      ...
      <section id="permit-guidance" className="scroll-mt-28 bg-[#f7f8f0] py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-8">
          <div>
            <SectionHeading
              title="Permit and Tree Commission guidance."
              text="Some tree decisions need more than a contractor estimate. Peter can help property owners understand local review questions, documentation, and preservation options without turning the website into a permit tracker."
            />
            <div className="mt-8">
              <CheckList items={permit} />
            </div>
          </div>
          <div className="rounded-md border border-emerald-950/10 bg-white p-6 shadow-[0_18px_42px_rgba(25,50,35,0.08)]">
            <MapPinned className="size-10 text-emerald-800" aria-hidden="true" />
            <h3 className="mt-5 text-2xl font-black text-emerald-950">Useful when the tree decision affects more than one person.</h3>
      ...
      <section id="about" className="scroll-mt-28 bg-white py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:px-8">
          <div className="rounded-md border border-emerald-950/10 bg-[#f7f8f0] p-6">
            <div className="overflow-hidden rounded-md border border-emerald-950/10 bg-white">
              <PeterHeadshot className="aspect-[1/1.05] w-full object-cover" />
            </div>
            <div className="mt-8 space-y-3 text-sm leading-6 text-stone-700">
              <ArboristLogo />
              <p className="font-black uppercase tracking-[0.14em] text-emerald-800">Peter Toler</p>
              <p className="text-2xl font-black leading-tight text-emerald-950">ISA Certified Arborist serving Mobile, Alabama.</p>
              <a href={isaCredentialUrl} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 font-black text-emerald-900 hover:text-emerald-700 focus-ring">
          ...
          <div>
            <SectionHeading
              title="About Peter."
              text="Peter provides independent arborist guidance for property owners who need a practical read on tree condition, risk, storm damage, preservation, and local decision-making. The value is not selling tree work. The value is knowing what work is actually needed before you pay for it."
            />
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-md border border-emerald-950/10 bg-[#f7f8f0] p-5">
                <TreePine className="size-8 text-emerald-800" aria-hidden="true" />
                <h3 className="mt-4 text-lg font-black text-emerald-950">Mature-tree decisions</h3>
                <p className="mt-2 text-sm leading-6 text-stone-700">Guidance for live oaks, storm-exposed trees, property lines, targets, and preservation tradeoffs.</p>
              </div>
              <div className="rounded-md border border-emerald-950/10 bg-[#f7f8f0] p-5">
                <Hammer className="size-8 text-emerald-800" aria-hidden="true" />
                <h3 className="mt-4 text-lg font-black text-emerald-950">Contractor clarity</h3>
                <p className="mt-2 text-sm leading-6 text-stone-700">Better questions and priorities before you compare quotes or authorize work.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f7f8f0] py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            center
            title="Practical confidence before the invoice."
            text="Independent assessment is useful when the decision has cost, safety, insurance, permit, or preservation consequences."
          />
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {credibilityCards.map((card) => (
              <article key={card.title} className="rounded-md border border-emerald-950/10 bg-white p-5">
                <Sprout className="size-8 text-lime-600" aria-hidden="true" />
                <h3 className="mt-4 text-xl font-black text-emerald-950">{card.title}</h3>
                <p className="mt-3 text-sm leading-6 text-stone-700">{card.text}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section id="education" className="scroll-mt-28 bg-white py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
          <div>
            <SectionHeading
              title="Field notes for better tree decisions."
              text="Short, practical guidance helps property owners ask better questions before storm season, before removal, and before paying for work that may not be the first priority."
            />
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <SchedulePhoneButton href={schedulePagePath} />
              <a href={photoSubmissionMailto} className="inline-flex items-center justify-center gap-2 rounded-md border border-emerald-800/30 bg-white px-5 py-3 text-sm font-black text-emerald-950 transition hover:border-emerald-800 hover:bg-emerald-50 focus-ring">
          ...
          <div className="grid gap-4">
            {education.map((post) => (
              <article key={post.title} className="rounded-md border border-emerald-950/10 bg-[#f7f8f0] p-5">
                <div className="flex items-start gap-4">
                  <Leaf className="mt-1 size-6 shrink-0 text-emerald-800" aria-hidden="true" />
                  <div>
                    <h3 className="text-base font-black leading-6 text-emerald-950">{post.title}</h3>
      ...
      <section id="schedule-call" className="scroll-mt-28 bg-[#0b1f17] py-16 text-white sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:px-8">
          <div>
            <CalendarDays className="size-10 text-lime-300" aria-hidden="true" />
            <h2 className="mt-5 text-3xl font-black leading-tight sm:text-4xl">Want to talk it through first?</h2>
            <p className="mt-4 max-w-3xl text-base leading-7 text-emerald-50/85">Schedule a phone consultation, send photos, or start with the assessment request form.</p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap lg:justify-end">
            <SchedulePhoneButton href={schedulePagePath} />
            <a href={photoSubmissionMailto} className="inline-flex items-center justify-center gap-2 rounded-md border border-white/25 bg-white/5 px-5 py-3 text-sm font-black text-white transition hover:border-lime-300 hover:bg-white/10 focus-ring">
      ...
      <section className="bg-[#06110d] px-4 py-16 text-white sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-black leading-tight sm:text-5xl">Get an independent assessment before the work begins.</h2>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-emerald-50/85">
      ...
      <footer className="border-t border-white/10 bg-[#030806] px-4 py-10 text-sm text-emerald-50/75 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm leading-6">The Arborist is Peter Toler&apos;s independent arborist consulting website for Mobile, Alabama property owners.</p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>Permit and Tree Commission guidance</li>
            </ul>
          </div>
          <div>
