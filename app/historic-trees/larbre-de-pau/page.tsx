      ...
      <section className="relative isolate overflow-hidden border-b border-teal-300/20 py-14 sm:py-20">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            <figure className="overflow-hidden rounded-2xl border border-[#f6c95a]/30 bg-white/[0.05] shadow-[0_20px_54px_rgba(0,0,0,0.22)]">
              <div className="relative aspect-[16/9]">
                <Image
                  src="/assets/larbre-de-pau-tree.jpg"
                  alt="The original L'Arbre de Pau live oak near Fort Condé in downtown Mobile, Alabama"
                  fill
                  priority
              ...
              <figcaption className="p-4 text-sm leading-6 text-emerald-50/72">
                The original live oak near Fort Condé at Royal and Church streets in downtown Mobile.
              </figcaption>
            </figure>

            <figure className="overflow-hidden rounded-2xl border border-teal-300/30 bg-white/[0.05] shadow-[0_20px_54px_rgba(0,0,0,0.22)]">
              <div className="relative aspect-[3/2]">
                <Image
                  src="/assets/larbre-de-pau-monument.jpg"
                  alt="The L'Arbre de Pau monument inscription dated April 26, 1981"
                  fill
                  className="object-cover"
                  sizes="(min-width: 768px) 50vw, 100vw"
                />
              ...
              <figcaption className="p-4 text-sm leading-6 text-emerald-50/72">
                The monument records the gift from Pau, France, and its connection to Mobile&apos;s restoration after Hurricane Frederic.
              </figcaption>
            </figure>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <article className="rounded-2xl border border-teal-300/20 bg-white/[0.05] p-5 sm:p-7">
            ...
            <div className="mt-6 rounded-2xl border border-[#f6c95a]/25 bg-[#050b12]/72 p-5">
              ...
              <blockquote className="mt-3 text-sm font-bold uppercase leading-7 tracking-[0.04em] text-emerald-50/88">
                L&apos;Arbre de Pau<br />
                Presented to the people of Mobile<br />
                From their sister city, Pau, France<br />
                Symbolic of the restoration after<br />
                Hurricane Frederic 1979<br />
                April 26, 1981
              </blockquote>
              <p className="mt-4 text-xs leading-5 text-emerald-50/62">
                Transcribed from the monument photographed on site.
              </p>
            </div>
          </article>
